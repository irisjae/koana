var names_from_location = {
    'Cyberport': ['Computational Thinking (Age 5-7)', 'STEM (Age 3-11)', 'KK Coder : Junior (Age 7-11)', 'KK Coder: Teens (Age 11-15)', 'Level 2' ,'Minecraft Coding (Age 7-15)', 'Challenger (Age 7-15)', 'Certification Courses (Age 11+)'],
    'Lai Chi Kok': ['Computational Thinking (Age 5-7)', 'STEM (Age 3-11)', 'KK Coder : Junior (Age 7-11)', 'KK Coder: Teens (Age 11-15)', 'Level 2', 'Minecraft Coding (Age 7-15)', 'Challenger (Age 7-15)', 'Certification Courses (Age 11+)'],
    ...
    'Tin Hau': ['Computational Thinking (Age 5-7)','KK Coder : Junior (Age 7-11)', 'KK Coder: Teens (Age 11-15)','Minecraft Coding (Age 7-15)']
};
