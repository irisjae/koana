...
riot.tag2('page-ranking', '<nav> <nav-bar> <nav-buttons> </nav-buttons> <nav-title> <component-page-title>Hello World! Ready to Code?</component-page-title> </nav-title> <nav-buttons> <a href="#home"> <component-logout-button></component-logout-button> </a> </nav-buttons> </nav-bar> </nav> <component-main-content> <ranking> </ranking> <component-spacing height="75px"></component-spacing> </component-main-content> <component-tabs></component-tabs>', '', '', function(opts) {
	(function (self, args, my) {
