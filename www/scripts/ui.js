...
riot.tag2('page-dashboard-create', __strs [13366], '', '', function(opts) {
	(function (self, args) {
...
riot.tag2('page-dashboard', __strs [2894233], '', '', function(opts) {
	(function (self, args) {
...
riot.tag2('page-login', __strs [5783574], '', '', function(opts) {
	(function (self, args) {
	...
	self .on ("update", function () {args = self .opts});
			...
			var _interaction = interaction_to_be (promise_of (function (is) {
				self .on ('mount', function () {
					var login_dom = self .root .querySelector ('#login[action=focus]');
					var make_account_dom = self .root .querySelector ('#make-account[action=side]');
...
riot.tag2('page-make-account', __strs [5858256], '', '', function(opts) {
	(function (self, args) {
	...
	self .on ("update", function () {args = self .opts});
			...
			var _interaction = interaction_to_be (promise_of (function (is) {
				self .on ('mount', function () {
					var make_account_dom = self .root .querySelector ('#make-account[action=focus]');
					var back_dom = self .root .querySelector ('#back[action=nav]');
					...
					var email_dom = self .root .querySelector ('#email');
					var password_dom = self .root .querySelector ('#password');
					var retype_password_dom = self .root .querySelector ('#retype-password');
